...
public class DictionaryArray {
    ...
    /**
     * Loads every word on a .txt to an TrieArray
     *
     * @throws IOException
     */
     ...
     * @return TrieArray from .dat file
     */
     ...
     * @return An arraylist containing all possible combinations with error
     * checking
     */
    ...
    public static ArrayList find(String word, boolean comb) {
        ...
        if (comb) {
            ...
            wordList.add(dictionary.find(word));
        }
        listSort();
        return wordList;
    }
